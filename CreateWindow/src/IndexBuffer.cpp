...
IndexBuffer::IndexBuffer(unsigned int indiceSize, const void * dataSource) :
	m_indices(indiceSize / sizeof(unsigned int))
{
...
{
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, m_Renderer);
	std::cout << "IndexBuffer m_Rendererid: " << m_Renderer << std::endl;
}
